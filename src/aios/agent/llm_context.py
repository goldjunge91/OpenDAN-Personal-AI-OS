                    ...
                    if func_set:
                        for func_id in func_set:
                            ...
                            if ai_func:
                                ...
                                logger.error(
                                    f"load_function_set_from_config failed! enable function id {func_id} not found!")
                                return None
                    else:
            ...
            for disable_function in disable_functions:
                if result.get(disable_function):
                    ...
                    if func_set:
                        ...
                        logger.error(
                            f"load_function_set_from_config failed! disable function id {disable_function} not found!")
                        return None
