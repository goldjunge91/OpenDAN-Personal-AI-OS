...
class AgentWorkspace:
    ...
    def register_ai_functions():
        ...
        parameters = ParameterDefine.create_parameters({
            "title": {"type": "string",
                      "description": "task title,Simple and clear, try to include the task \ Related personnel \ place \ key conditions \ time element involved in the event"},
        ...
        parameters = ParameterDefine.create_parameters({
            ...
            "next_attention_time": {"type": "isoformat time string",
                                    "description": "optional,confirm task next attention time"},
            "expiration_time": {"type": "isoformat time string",
                                "description": "optional,confirm task expiration time"},
            # "due_date": {"type": "isoformat time string", "description": "optional,confirm task due date"},
        ...
        parameters = ParameterDefine.create_parameters({
            ...
            "next_attention_time": {"type": "isoformat time string",
                                    "description": "optional,update task next attention time"},
        ...
        parameters = ParameterDefine.create_parameters({
            ...
            "new_state": {"type": "string",
                          "description": "optional,new todo state: execute_ok , execute_failed, done or check_failed"},
        })
