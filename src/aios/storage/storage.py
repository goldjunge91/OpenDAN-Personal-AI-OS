...
class UserConfig:
    def __init__(self) -> None:
        ...
        self._init_default_value("llm_outline_model", "gpt-4o-mini")
        self._init_default_value("llm_swift_model", "gpt-4o-mini")
    ...
    def add_user_config(self, key: str, desc: str, is_optional: bool, default_value: Any = None,
                        item_type="str") -> None:
        if self.config_table.get(key) is not None:
            logger.warning("user config key %s already exist, will be overrided", key)
